...
org.puremvc.haxe.multicore.utilities.asyncstub = {}
org.puremvc.haxe.multicore.utilities.asyncstub.model = {}
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy = function(name) { if( name === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.proxy.Proxy.apply(this,[name]);
	this.maxDelayMSecs = 15000;
	this.probabilityOfFault = 0.;
	this.asyncInProgress = false;
}}
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.__name__ = ["org","puremvc","haxe","multicore","utilities","asyncstub","model","AsyncStubProxy"];
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.__super__ = org.puremvc.haxe.multicore.patterns.proxy.Proxy;
for(var k in org.puremvc.haxe.multicore.patterns.proxy.Proxy.prototype ) org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype[k] = org.puremvc.haxe.multicore.patterns.proxy.Proxy.prototype[k];
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.asyncAction = function(resultFunction,faultFunction) {
	...
	this.timer = new org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer(onCompletion,msecsDelay,1);
	this.timer.start();
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.asyncInProgress = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.calcCompletionFunction = function() {
...
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.clientFaultFunction = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.clientResultFunction = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.maxDelayMSecs = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.onFault = function() {
	this.timer.stop();
	this.asyncInProgress = false;
	this.clientFaultFunction(this.token);
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.onResult = function() {
	this.timer.stop();
	this.asyncInProgress = false;
	this.clientResultFunction(this.token);
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.probabilityOfFault = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.timer = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.token = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.prototype.__class__ = org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy;
org.puremvc.haxe.multicore.utilities.asyncstub.model.AsyncStubProxy.__interfaces__ = [org.puremvc.haxe.multicore.interfaces.IProxy];
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer = function(callBack,milliInterval,maxTicks) { if( callBack === $_ ) return; {
...
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.__name__ = ["org","puremvc","haxe","multicore","utilities","asyncstub","model","Timer"];
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.callBack = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.maxTicks = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.milliInterval = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.reset = function() {
	this.ticks = 0;
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.start = function() {
	this.stopped = false;
	haxe.Timer.delay($closure(this,"tick"),this.milliInterval);
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.stop = function() {
	this.stopped = true;
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.stopped = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.tick = function() {
	if(this.stopped || this.ticks == this.maxTicks) return;
	this.callBack();
	this.ticks++;
	haxe.Timer.delay($closure(this,"tick"),this.milliInterval);
}
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.ticks = null;
org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer.prototype.__class__ = org.puremvc.haxe.multicore.utilities.asyncstub.model.Timer;
